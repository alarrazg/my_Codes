...
class SalaCine:
    ...
    def reservar_asiento(self, edad, dia):
        """
        Reserva el primer asiento disponible y calcula el precio final.
        ...
        Raises:
            ValueError: Si no hay asientos disponibles.
        """
        for asiento in self.asientos:
...
def main():
    ...
    for i in range(numero_asistentes):
        sala.reservar_asiento(edades[i], dia)
